defmodule Per.Lexer.Agda do
  ...
  defp lex([], _line, _col, acc), do: Enum.reverse(acc)
  ...
  defp lex([?< | rest], line, col, acc), do: lex(rest, line, col + 1, [{:left_angle, line, col} | acc])
  defp lex([?> | rest], line, col, acc), do: lex(rest, line, col + 1, [{:right_angle, line, col} | acc])
  ...
  defp lex([c | rest], line, col, acc)
    ...
    case ident do
      ...
      "data" -> lex(rest2, line, col + String.length(ident), [{:data_kw, line, col} | acc])
      "record" -> lex(rest2, line, col + String.length(ident), [{:record_kw, line, col} | acc])
      "infix" -> lex(rest2, line, col + String.length(ident), [{:infix_kw, line, col} | acc])
      "infixl" -> lex(rest2, line, col + String.length(ident), [{:infixl_kw, line, col} | acc])
      "infixr" -> lex(rest2, line, col + String.length(ident), [{:infixr_kw, line, col} | acc])
      ...
      "postulate" -> lex(rest2, line, col + String.length(ident), [{:postulate_kw, line, col} | acc])
